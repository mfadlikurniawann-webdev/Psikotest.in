...
<head>
    ...
    <title>Daftar - Psikotest.in</title>
...
<!-- Left Panel (Desktop) - Identical to Login Page -->
<div class="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col justify-between p-12 border-r border-slate-800">
    ...
    <div>
        ...
        <p class="text-slate-400 leading-relaxed text-sm max-w-md">
            Selamat datang di sistem asesmen resmi perusahaan. Silakan daftarkan akun Anda untuk memulai sesi ujian psikotes terpadu dan pengukuran kompetensi kerja secara realtime.
        </p>
...
<!-- Right Panel (Form) - Matches Login Style exactly but with registration inputs -->
<div class="flex-1 flex items-center justify-center p-6 bg-slate-50 overflow-y-auto py-12">
    <div class="w-full max-w-md">
        ...
        <h1 class="text-2xl font-bold text-slate-900 mb-1">Registrasi Akun</h1>
        <p class="text-slate-500 text-sm mb-8">Sudah memiliki akun? <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-700 font-semibold transition">Masuk di sini</a></p>
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-slate-900 text-sm bg-white placeholder-slate-400 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition"
                ...
                <div>
                    <label class="block text-slate-700 text-xs font-bold uppercase tracking-wider mb-1.5">Konfirmasi</label>
                ...
                <div>
                    <label class="block text-slate-700 text-xs font-bold uppercase tracking-wider mb-1.5">Nomor Telepon</label>
                ...
                <div>
                    <label class="block text-slate-700 text-xs font-bold uppercase tracking-wider mb-1.5">Tanggal Lahir</label>
                    <input type="date" name="birth_date" value="{{ old('birth_date') }}"
                        class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-slate-900 text-sm bg-white focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition">
                </div>

                <div>
                    <label class="block text-slate-700 text-xs font-bold uppercase tracking-wider mb-1.5">Pendidikan</label>
                ...
                <div>
                    <label class="block text-slate-700 text-xs font-bold uppercase tracking-wider mb-1.5">Posisi Dilamar</label>
            ...
            <button type="submit" class="w-full bg-slate-900 hover:bg-slate-800 text-white font-semibold py-3 rounded-xl transition text-sm shadow-sm mt-4">
                Daftar & Mulai Tes
            </button>
        </form>
        ...
        <div class="mt-6 pt-6 border-t border-slate-200">
            <p class="text-center text-slate-400 text-xs leading-normal">
                Dengan mendaftar, Anda menyetujui bahwa pengerjaan tes dilakukan secara mandiri, jujur, dan transparan.
            </p>
        </div>
    </div>
</div>
